...
export const DEFAULT_PROVIDER = _DEFAULT_PROVIDER;
...
async function withRetry<T>(fn: () => Promise<T>, provider: string, maxAttempts = LLM_MAX_RETRY_ATTEMPTS): Promise<T> {
...
// Model instance cache — avoids creating new instances per call
